...
files:
  - url: bigCode-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: bigCode-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: bigCode-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: bigCode-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: bigCode-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: bigCode-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
const tempRoot = mkdtempSync(join(tmpdir(), "bigcode-release-smoke-"));
...
try {
  ...
  assertContains(
    mergedManifest,
    "bigCode-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "bigCode-9.9.9-smoke.0-x64.zip",
