...
import { GitCommandError, GitHubCliError, TextGenerationError } from "@bigcode/contracts";
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/youpele52/bigCode/pull/1661",
                  baseRefName: "main",
                  headRefName: "main",
                  state: "OPEN",
              ...
              "effect-atom": JSON.stringify([
                {
                  number: 1618,
                  title: "Correct PR",
                  url: "https://github.com/youpele52/bigCode/pull/1618",
                  baseRefName: "main",
              ...
              "upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/youpele52/bigCode/pull/1518",
                  baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/youpele52/bigCode/pull/642",
            baseRefName: "main",
