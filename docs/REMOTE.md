...
Use this when you want to open bigCode from another device (phone, tablet, another laptop).

## CLI ↔ Env option map

The bigCode CLI accepts the following configuration options, available either as CLI flags or environment variables:
