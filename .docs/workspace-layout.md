...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@bigcode/shared/git`, `@bigcode/shared/DrainableWorker`) — no barrel index.
